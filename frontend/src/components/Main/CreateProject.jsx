          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Row className="mb-3 border-top">
              ...
              <Form.Group as={Col} md="4" controlId="validationCustom04">
                ...
                <Dropdown onSelect={(eventKey) => setStatus(eventKey)} aria-label="Status" required>
                  <Dropdown.Toggle variant="light" className="bg-white border">
                    {status}
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                    <Dropdown.Item eventKey="Not starteddd">Not starteddd</Dropdown.Item>
                    <Dropdown.Item eventKey="Ongoingg">Ongoingg</Dropdown.Item>
                    <Dropdown.Item eventKey="Finisheddd">Finisheddd</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </Form.Group>
            </Row>
            ...
            <Dropdown onSelect={(eventKey) => setProduct(eventKey)} aria-label="Product" required>
                  <Dropdown.Toggle variant="light" className="bg-white border">
                    {product}
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                    <Dropdown.Item eventKey="Educationnn">Educationnn</Dropdown.Item>
